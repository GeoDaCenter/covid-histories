...
interface WrittenSubmissionEditorProps {
	...
	getCachedEntry: (
		entry: SubmissionDraft | undefined
	) => string | Blob | undefined
	dbActive: boolean
}

export const WrittenSubmissionEditor: React.FC<
	WrittenSubmissionEditorProps
> = ({ storyId, dbActive, text, setText, handleChange, getCachedEntry }) => {
