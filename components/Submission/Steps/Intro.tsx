	...
	return (
		<Grid container spacing={1} minHeight="75vh" justifyContent="center" alignContent="center">
			<Grid item xs={12} sm={6} justifyContent="center" alignContent="center" display="flex" flexDirection="column">
				...
				<Typography>
					We know that the pandemic has impacted everyone&apos;s life. 
					And essentially everyone has a story to tell about their experience.
					By participating in this oral history, whether you decide to do a video, 
					write, audio, or upload a picture you will ultimately be lifting up your 
