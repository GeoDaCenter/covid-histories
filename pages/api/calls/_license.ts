...
Make a digital reproduction of my Licensed Material and to retain the digital reproduction.

Display digital reproductions of my Licensed Material via the Internet or successive technologies.

Create derivative works from my Licensed Material such as edits or compilations.

Distribute copies of my Licensed Material or derivatives to users and partners of the Atlas and the University.

To grant third parties any of the foregoing rights.

Identity and Authorship

In the publication of my Licensed Material in the Atlas, the following information will be made publicly available:

The photos, audio, video, written, or other materials I provide, in part or in whole.
The center point or spatial boundary of the US county I provide as the location for this story, but no more detailed location information.
My name will not be associated with my oral history unless I choose to include it. I can choose the form option "Attribute my Video" and my name will then be associated with the published materials.
There is additional information collected in my submission that will not be made publicly available:
My reported race, ethnicity, gender, and other demographic survey information.
My email or contact information, affiliations, and other digitally collected information
...
Go to stories.uscovidatlas.org/my-stories, enter the password you received via email, and select the option to request removal of your materials.
Alternatively, email theuscovidatlas@gmail.com and request your materials be removed.
