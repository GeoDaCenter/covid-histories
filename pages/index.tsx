...
const ProgressIndicator: React.FC<{ containerRef: any }> = ({
	containerRef
}) => {
...
const Home: NextPage = () => {
	...
	const [experiencesRef, experiencesInView] = useInView({ threshold: 0.5 })
	const storyTypesScrollRef = useRef<HTMLElement | null>(null)
	const [moreThanDataRef, moreThanDataInView] = useInView({ threshold: 0.5 })
	const moreThanDataScrollRef = useRef<HTMLElement | null>(null)
	const [questionsRef, questionsInView] = useInView({ threshold: 0.5 })

	const { background, currSectionName, currSectionIndex }: StepParams =
		getStepBackground({
			homeInView,
			exampleMapInView,
			experiencesInView,
	...
	const scrollToExampleMap = () =>
		mapScrollRef?.current &&
		mapScrollRef.current.scrollIntoView({ behavior: 'smooth', block: 'center' })
	const scrollToStoryTypes = () =>
		storyTypesScrollRef?.current &&
		storyTypesScrollRef.current.scrollIntoView({
			behavior: 'smooth',
			block: 'center'
		})
	const scrollToPrivacy = () =>
		moreThanDataScrollRef?.current &&
		moreThanDataScrollRef.current.scrollIntoView({
			behavior: 'smooth',
			block: 'center'
		})
		...
		<div className={styles.container} style={{ background }} ref={containerRef}>
				...
				<Grid container spacing={2} alignContent="center" alignItems="center">
					<Grid item xs={12} md={6}>
						...
						<Typography variant="h2" component="h1">
							Share <span className="cursive">your story</span>
							<br />
							of the pandemic
						</Typography>
						<Typography paddingTop="1em">
							...
							This project collects stories behind the statistics and data. We
						...
						<Typography>
							...
							and Atlas Stories are led by the Healthy Regions and Policies Lab
							at the University of Chicago. This is a not-for-profit research
							project that works to understand, archive, and represent the often
							unequal impact of the COVID-19 pandemic in the US.
						</Typography>
						...
						<Box sx={{ pt: 1 }}>
							<ScrollLinkButton
								onClick={scrollToExampleMap}
								text="How will my story be visualized?"
							/>
							<ScrollLinkButton
								onClick={scrollToStoryTypes}
								text="What kind of story can I share?"
							/>
							<ScrollLinkButton
				...
				>
					<Grid item xs={12} md={6} display="flex">
						<img
							width="90%"
							height="auto"
							className={currSectionName === 'homeInView' ? styles.fadeIn : ''}
					...
					<Grid item xs={12} md={6}>
						...
						<Typography paddingTop="1em">
							Your story can be a part of the US Covid Atlas archive, adding
							critical context to the data. Stories will be tagged
							geographically to your county, so shared experiences of your
							community can be explored together.
						</Typography>
						<CtaLink href="/submit" className="cta-button">
							Share your story
						</CtaLink>
			...
			>
				...
				<Typography>
					...
					different stories about your experiences of COVID-19 in the United
					States. Choose the type of story you would like to submit, or scroll
				...
				<Grid container ref={storyTypesScrollRef}>
					<Grid item xs={12} sm={6} md={3}>
						<span
							className={
								currSectionName === 'experiencesInView' ? styles.fadeIn : ''
							}
						>
							<StoryTypeContainer>
								<Icons.video />
			...
			>
				...
				<Grid container spacing={3} ref={moreThanDataScrollRef}>
					<Grid item xs={12} sm={6}>
						...
						<Typography>
							Atlas Stories expands the data on the US Covid Atlas to
							contextualize how and what you experienced during the pandemic.
							Stories are layered on top of our map of COVID-19 data at the
							county level. We’re working to collect an equitable group of
							stories from across the U.S., from cities, towns, suburbs, and
					...
					<Grid
						...
						sm={6}
						className={
							currSectionName === 'moreThanDataInView' ? styles.fadeIn : ''
						}
						style={{ animationDelay: '250ms' }}
					>
			...
			>
				<Grid container spacing={3}>
					<Grid item xs={12} sm={6}>
						...
						<Typography>
							We’re here to make telling your story easy. Contact us with any
							questions about how to share your story, the terms and license
							agreement, and how your story may be published.
						</Typography>
					</Grid>
					<Grid
						item
